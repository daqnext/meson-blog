...
tags: ['Meson', 'ENS']
draft: false
summary: ETH.Radio is a high-availability Ethereum Name Service (ENS) gateway. It represents a significant step towards the adoption of the decentralized web (dweb) by offering a new way to access ENS resolvable domains. Prior to the launch of ETH.Radio, services such as Cloudflare’s eth.link and the community-driven eth.limo were the primary means of bridging the gap between Web2 and Web3.
