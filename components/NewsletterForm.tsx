...
const NewsletterForm = ({
  ...
  return (
    <div className="group relative">
      <div className="animate-tilt absolute -inset-px animate-pulse rounded-2xl bg-gradient-to-r from-blue-500 via-[#3B82F6] to-[#9333EA] blur-md transition duration-1000 group-hover:-inset-1 group-hover:animate-none group-hover:opacity-100 group-hover:duration-1000"></div>
      <div className="relative h-full w-full rounded-2xl bg-white px-6 py-6 dark:bg-background-color sm:py-8 sm:px-12">
        ...
        <form className="relative flex flex-col" onSubmit={subscribe}>
          <div>
            ...
            <input
              autoComplete="email"
              className="w-full rounded-xl px-4 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-black"
              id="email-input"
              name="email"
