      ...
      <div className="mt-6 divide-y px-2 sm:px-0">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            <input
              ...
              className="block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-background-color focus:border-x-blue-500 focus:ring-blue-500 dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100"
            />
            <svg
        ...
        <div className="dark:border-gray-700">
          ...
          {displayPosts.map((frontMatter, index) => {
            ...
            return (
              <Link href={`/announcements/${slug}`} key={slug}>
                  ...
                  <div className="group w-full transform border-b border-gray-200 py-3 transition-all hover:scale-[1.02] dark:border-gray-700">
                    <div className="flex flex-col justify-between sm:flex-row sm:items-center">
                      <div className="flex items-center">
                        ...
                        <h4 className="w-full text-base font-medium text-background-color group-hover:font-bold group-hover:text-blue-500 dark:text-white sm:text-lg">
                          {title}
                        </h4>
                      </div>
