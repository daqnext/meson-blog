...
const gradients = {
  ...
  '6': ' from-blue-200 via-blue-400 to-purple-700',
  '7': ' from-red-200 to-red-600',
  '8': ' from-blue-300 via-yellow-300 to-pink-300',
        ...
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            <input
              ...
              className="block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 focus:border-x-blue-500 focus:ring-blue-500 dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100"
            />
            <svg
